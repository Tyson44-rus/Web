...
function changeTheme() {
    ...
    if (flag) {
        ...
        elem.attr("href", "static/styles/auth_reg_2.css");
    } else {
        flag = true;
        // $.post("./php/theme.php", {"theme": "0"});

        elem.attr("href", "static/styles/auth_reg.css");
    }
}
...
$(document).ready(() => {
    ...
    //     let elem = $("#css_theme");
    //     if (flag){
    //         elem.attr("href", "/styles/auth_reg.styles");
    //     }
    //     else{
    //         elem.attr("href", "/styles/auth_reg_2.styles");
    //     }
    // });
